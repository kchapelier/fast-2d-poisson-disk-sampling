...
describe('Fast Poisson Disk Sampling', function () {
    describe('fill()', function () {
        it('should return an array of points', function () {
            var pds = new PDS({ shape: [50, 30], radius: 4, tries: 10 }),
                points = pds.fill();
    ...
    describe('addRandomPoint()', function () {
        ...
        it('should ignore the distance constraints', function () {
            var pds = new PDS({ shape: [2, 2], radius: 8, tries: 10 });
        ...
        it('should be using the provided rng function', function () {
            ...
            var pds = new PDS({ shape: [50, 30], radius: 4, tries: 10 }, riggedRng),
                point1 = pds.addRandomPoint(),
                point2 = pds.addRandomPoint();
    ...
    describe('next()', function () {
        ...
        it('should check the distance constraints and return null if it cannot place any point', function () {
            var pds = new PDS({ shape: [2, 2], radius: 8, tries: 20 });
    ...
    describe('general behavior', function () {
        it('should respect the radius', function () {
            var pds = new PDS({
                shape: [50, 50],
                radius: 4,
                tries: 10
        ...
        it('shoup accept "minDistance" instead of "radius" for API compatibility with poisson-disk-sampling', function () {
            var pds = new PDS({
                shape: [50, 50],
                minDistance: 4,
                tries: 10
